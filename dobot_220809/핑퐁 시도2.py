...
def dobot_get_start():
    ...
    dType.SetJOGJointParams(api, 1000, 700, 700,480,300, 300, 300, 300, 0)
    dType.SetJOGCoordinateParams(api,1000,900,900,480,300,300,300,300,0)
    dType.SetJOGCommonParams(api, 1000,350,0)

    dType.SetPTPJointParams(api,320,320,320,480,300,300,300,300,0) # velocity[4], acceleration[4]
    dType.SetPTPCoordinateParams(api,900,900,480,300,0) 
...
def hit(of_x,of_y):
    ...
    if length > 80 and length < 270:
        ...
        dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, offset_x, offset_y, -20, -100, isQueued = 1)
...
if __name__ == '__main__':
    ...
    while(1):
        ...
        if len(q) > 2:
            ...
            if predict_t < 3 and predict_t > 0 and of_y > 60 and hit_count == 0:
